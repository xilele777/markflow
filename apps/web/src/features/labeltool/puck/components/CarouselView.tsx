...
export const CarouselView: ComponentConfig<CarouselViewProps> = {
  ...
  // render 只做转发：hooks 放在真正的函数组件 CarouselViewRender 里（rules-of-hooks）。
  render: (props) => <CarouselViewRender {...props} />,
};

function CarouselViewRender({ label, sampleField, height, fit, autoplay, interval, showDots, showArrows }: CarouselViewProps) {
