...
export const CaseErrorCode = defineErrorCodes({
  ...
  DATASET_TOOL_MISMATCH: '需要与所选标注工具匹配的源数据集',
  ...
  CASE_STATUS_TRANSITION_INVALID: '当前状态不允许该操作',
  CASE_FINISHED: '标注任务已结束',
  DEADLINE_INVALID: '截止时间不合法',
...
export const TaskErrorCode = defineErrorCodes({
  ...
  TASK_STATE_CHANGED: '任务已回收或轮次已变更，请刷新后重试',
